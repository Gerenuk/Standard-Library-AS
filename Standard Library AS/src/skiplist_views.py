...
#===============================================================================
# TODO:
# - exponential distribution for level from scipy
# - why math.e
# - why views? why iteritems?
#===============================================================================
...
class KeysView(MappingView, colabc.KeysView):
    ...
    def __iter__(self):
        for k, _v in self._mapping._items(self._start_key, self._reverse):
            yield k
...
class ValuesView(MappingView, colabc.ValuesView):
    ...
    def __iter__(self):
        for _k, v in self._mapping._items(self._start_key, self._reverse):
            yield v


class SkipListDict(colabc.MutableMapping):
    def __init__(self, capacity=65535, random=random.random, p=1 / math.e):
